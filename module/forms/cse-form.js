...
export class PTUCustomSpeciesEditor extends FormApplication {
    ...
    getData() {
      ...
      this.object = foundry.utils.isEmpty(this.object ?? {}) ? data.species[0] : this.object.state == "new" ? {} : this.object;
    ...
    activateListeners(html) {
      ...
      html.find('.delete-cse').click(async (ev) => {
        ...
        log(`Deleting mon with ID: ${this.object.number}. Data backup:`, foundry.utils.duplicate(customSpeciesData.data[index]));
    ...
    async _updateObject(event, formData) {
      ...
      foundry.utils.mergeObject(this.object, this.formatFormData(formData));
