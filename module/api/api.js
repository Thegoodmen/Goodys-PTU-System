    ...
    _setupHandlers() {
        ...
        return {
            ...
            async transferOwnership(data) {
                ...
                const newData = {
                    folder: pc.folder?.id,
                    permission: foundry.utils.mergeObject({
            ...
            async applyDamage(data) {
                ...
                for (const document of documents) {
                    ...
                    retVal.appliedDamage[document.actorLink ? document.actor.id : (document._id ?? document.id)] = {
                        ...
                        old: {
                            value: foundry.utils.duplicate(document.actor.system.health.value),
                            temp: foundry.utils.duplicate(document.actor.system.tempHp.value),
                            injuries: foundry.utils.duplicate(document.actor.system.health.injuries)
                        },
