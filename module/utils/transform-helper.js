  ...
  export default async function transform() {
    ...
    if (!alreadyTransformed){
      ...
      await selectedActor.createEmbeddedDocuments("Item", foundry.utils.duplicate(targetItems))
      ...
      await selectedActor.createEmbeddedDocuments("ActiveEffect", [TransformEffect]);
        ...
        await selectedActor.createEmbeddedDocuments("Item", foundry.utils.duplicate(initialItems))
