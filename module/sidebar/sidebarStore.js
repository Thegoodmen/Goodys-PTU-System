    ...
    const store = new Store({
        actions: {
            ...
            async updateMoves(context, moves) {
                ...
                await context.commit('updateMoves', foundry.utils.duplicate(moves));
            },
            async updateAbilities(context, abilities) {
                ...
                await context.commit('updateAbilities', foundry.utils.duplicate(abilities));
            },
            async updateFeatures(context, features) {
                ...
                await context.commit('updateFeatures', foundry.utils.duplicate(features));
            },
